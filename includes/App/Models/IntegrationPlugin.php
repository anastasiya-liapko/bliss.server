 ...
 */
class IntegrationPlugin extends \Core\Model {
  ...
  public function create() {
    ...
    if ( empty( $this->errors ) ) {
      $sql = 'INSERT INTO integration_plugins (name, img_url, url, orderby) VALUES (:name, :img_url, :url, :orderby)';
